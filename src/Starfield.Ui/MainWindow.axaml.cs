...
/// <remarks>
/// Everything that needs the platform lives here: the save dialog and loading PNG bytes into brushes
/// and images. Everything else is bound to <see cref="MainViewModel"/>.
/// </remarks>
